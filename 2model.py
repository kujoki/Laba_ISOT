...
# 2PL model
model_2 = pystan.StanModel(file='/home/katya/Downloads/output/models/2model.stan', model_name='model_2')
...
fit_model_2.to_dataframe().to_csv('/home/katya/Downloads/output/2model.csv')
